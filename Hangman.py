...
print (" 1) Players should try to figure out an unknown word by guessing letters.(Hint-Fruits)")
print()

time.sleep(2)
print(" 2) As letters in the word are guessed, that letter gets printed above its cooresponding underline.")
print()

time.sleep(2)
print(" 3) If the letter you guessed is not in the word, one part of the person gets hanged.")
print()
...
time.sleep(2)
print(" 5) So to win, you have to guess the word before you finish all your chances.")
print()

time.sleep(2)
print(" 6) If you finish all your chances, then the man will be hanged and you will loose.")
print()
